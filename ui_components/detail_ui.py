...
class DetailUI:
    ...
    def display_detail_page(self, instance_id: str):
        ...
        st.markdown("<a href='/' target='_self' style='text-decoration: none; display: inline-block; margin-top: 1rem; margin-bottom: 0.5rem;'>← Volver al Dashboard</a>", unsafe_allow_html=True)
        if not details:
